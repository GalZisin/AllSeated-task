...
var singleton_1 = __importDefault(require("../singleton/singleton"));
var async_lock_1 = __importDefault(require("async-lock"));
var SingletonRunner = /** @class */ (function () {
    function SingletonRunner() {
        this.array = [];
        this.lock = new async_lock_1.default();
    }
    SingletonRunner.prototype.userOperation = function (user, distance, maxUsers) {
        return __awaiter(this, void 0, void 0, function () {
            var singletonArray, allUsersarray, done;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        singletonArray = singleton_1.default.getInstance();
                        allUsersarray = [];
                        console.log("Execute operation1");
                        return [4 /*yield*/, this.aquireLock("key1")];
                    case 1:
                        done = _a.sent();
    ...
    SingletonRunner.prototype.aquireLock = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.lock.acquire(key, function (done) {
                            resolve(done);
                        }, function (err) {
                            if (err) {
                                reject(err);
...
exports.default = SingletonRunner;
